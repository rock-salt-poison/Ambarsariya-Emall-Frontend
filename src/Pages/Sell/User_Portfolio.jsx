...
function User_Portfolio(props) {
  ...
  const buttonsData = [
    ...
    },
    {
      ...
      description:
        "By This service Enabling you are giving permission to your G-contacts, G-MAPS, G-calendar, G-meet.",
      popup_body_content: (desc) => (
        <GmailServicesPopupContent description={desc} />
      ),
    },
    {
      id: 3,
    ...
    <ThemeProvider theme={theme}>
      <Box className="user_portfolio_wrapper">
                ...
                {isSpeedDialVisible && (
                  ...
                  >
                    <SpeedDialAction
                      ...
                      onClick={() =>
                        document
                          .getElementById("display-picture-upload")
                          .click()
                      }
                    />
                    <SpeedDialAction
                      ...
                      onClick={() =>
                        document
                          .getElementById("background-picture-upload")
                          .click()
                      }
                    />
                  </SpeedDial>
                ...
                {buttonsData.map((btn) => {
                  return (
                    <AnimatedButton
                      ...
                      text={btn.title}
                      popup_body_content={
                        typeof btn.popup_body_content === "function"
                          ? btn.popup_body_content(btn.description)
                          : btn.popup_body_content
                      }
                    />
                  );
                })}
        ...
        <CardBoardPopup
          ...
          title="Details"
          body_content={<DetailsPopupContent />}
        />
      </Box>
    </ThemeProvider>
  );
