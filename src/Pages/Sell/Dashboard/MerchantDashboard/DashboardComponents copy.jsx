...
function DashboardComponents({ data, date }) {
  ...
  const card_data = [
    ...
    { id: 7, heading: "P.O. Number", value: "-", slider:true },
    { id: 8, heading: "S.O. Number", value: "-" },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    const product_data = products[0];
        ...
        const saleOrderData = {
          ...
          discounts: product_data.discount_amount === '0.00' ? null : product_data.discount_amount,
          ...
          {card_data.map((card) => {
            return card.slider ? (
              <Box className='card w-6'>
                  ...
                  {purchasedOrders.length>0 ? <Swiper
                    slidesPerView={1}
                    spaceBetween={30}
                    // loop={true}
                    // autoplay={{
                  ...
                  >
                    ...
                    </Swiper> :<Typography className="number">-</Typography>
                  }
              </Box>
            ):(
