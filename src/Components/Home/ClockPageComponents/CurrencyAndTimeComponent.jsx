...
const rows = [
  ...
  createData(
    "3",
    {
      icon: indian_currency_icon,
      price: "100",
      optionalClassName: "rupeeIcon",
    },
    { icon: new_zealand_currency_icon, price: "1.17" },
    { icon: canadian_currency_icon, price: "1.97" }
  ),
];
